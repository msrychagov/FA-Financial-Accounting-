...
final class TransactionsServiceMok {
    ...
    var transactionsStorage: [Int:Transaction] = [
            ...
            3:Transaction(id: 3,
                          account: BankAccount(id: "g5ldpb73", name: "Основной счёт", balance: 15000.50, currency: "RUB"),
                          category: Category(id: 3, name: "Подработка", emoji: "💰", isIncome: true),
                          amount: 500.00,
            ...
            5:Transaction(id: 5,
                          account: BankAccount(id: "g5ldpb73", name: "Дополнительный счёт", balance: 1000.00, currency: "USD"),
                          category: Category(id: 2, name: "На собаку", emoji: "🐕", isIncome: false),
                          amount: 1000.00,
            ...
            6:Transaction(id: 6,
                          account: BankAccount(id: "g5ldpb73", name: "Дополнительный счёт", balance: 1000.00, currency: "USD"),
                          category: Category(id: 7, name: "Ремонт", emoji: "🔨", isIncome: false),
                          amount: 30.00,
                          transactionDate: "2025-07-11T23:42:34.083Z".convertToDate()!,
            ...
            7:Transaction(id: 7,
                          account: BankAccount(id: "g5ldpb73", name: "Дополнительный счёт", balance: 1000.00, currency: "USD"),
                          category: Category(id: 4, name: "Аптека", emoji: "⛑️", isIncome: false),
                          amount: 30.00,
            ...
            8:Transaction(id: 8,
                          account: BankAccount(id: "g5ldpb73", name: "Дополнительный счёт", balance: 1000.00, currency: "USD"),
                          category: Category(id: 5, name: "На любимую", emoji: "❤️", isIncome: false),
                          amount: 30.00,
            ...
            9:Transaction(id: 9,
                          account: BankAccount(id: "g5ldpb73", name: "Дополнительный счёт", balance: 1000.00, currency: "USD"),
                          category: Category(id: 6, name: "Ставки", emoji: "⚽️", isIncome: false),
                          amount: 50000.00,
