...
actor SwiftDataBackupTransactionsOperations: BackupTransactionsOperations {
    ...
    func saveOperation(_ operation: TransactionsOperation) async throws {
        do {
            ...
            throw StorageErrors.BackUpTransactionsOperation.saveOperationError
        }
    }
    ...
    func removeOpeartion(with id: String) async throws {
        ...
        do {
            ...
            throw StorageErrors.BackUpTransactionsOperation.deleteOperationError
        }
    }
